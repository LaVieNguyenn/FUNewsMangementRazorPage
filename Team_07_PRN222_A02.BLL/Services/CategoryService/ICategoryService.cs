...
namespace Team_07_PRN222_A02.BLL.Services.CategoryService
{
    public interface ICategoryService
    {
        ...
        Task<IEnumerable<CategoryDTO>> GetAllCategoryAsync(); // Get all top-level categories
        ...
        Task<CategoryDTO> GetCategoryByIdAsync(int id); // Get category by ID
        Task UpdateCategoryAsync(Category category); // Update an existing category
    }
}
